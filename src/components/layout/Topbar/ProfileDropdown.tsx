...
function ProfileDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      {/* Tombol Pemicu Dropdown - Kodenya Tetap Sama */}
      <button
        onClick={() => setIsDropdownOpen(!isDropdownOpen)}
        className="flex items-center gap-3 p-1 md:pr-3 rounded-full border border-divider hover:border-primary-main/50 bg-bg-default focus:outline-none transition-all"
        aria-haspopup="true"
